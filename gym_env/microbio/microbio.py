...
这个环境模拟了细菌对抗生素的演化过程，作为单目标强化学习问题。
代理根据当前种群状态选择抗生素，目标是最小化整体细菌适应度。
...
class SingleEvolvingEnv(Env, EzPickle):
    """
    单目标 E. coli 环境。
    假设目标是最小化种群的平均适应度。
    ...
    奖励: 1 - average_fitness (适应度越低，奖励越高)
    """
    def __init__(self, 
    ...
    def step(self, action):
        ...
        # 奖励 = 1 - 平均适应度（适应度越低，奖励越高）
        reward = 1.0 - avg_fitness
